...
public class TopicService {
	...
	public CompletableFuture<Page<Topic>> getFollowed(final Pageable page) {
		CompletableFuture<Page<Topic>> followers = repo.getFollowed(context.getAuthentication(), page);
